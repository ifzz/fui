...
import com.hundsun.jres.fui.tag.container.FToolGroupItemProcessor;
 ...
 * 开发时间: 2012-9-21 <br>
 */
public class FContainerItemTag extends FTagWithContent
{
	...
	{
		return new FToolGroupItemProcessor();
	}
