 ...
 * 开发时间: 2012-10-10 <br>
 */
public class FTabsProcessor extends FTemplateTagProcessor
{
	...
	public String process() throws FException
	{
		...
		// 调用模板引擎
		String result = FEnvironment.get().getTemplateEngineWrapper().process(fcontext, "impl/FUI.Tabs-impl.ftl", data);
		return result;
	}
}
