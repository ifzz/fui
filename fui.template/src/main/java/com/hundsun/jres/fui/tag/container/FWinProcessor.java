 ...
 */
public class FWinProcessor extends FTemplateTagProcessor
{
	...
	public String process() throws FException
	{
		...
		// 调用模板引擎
		String result = FEnvironment.get().getTemplateEngineWrapper().process(fcontext, "impl/FUI.Win-impl.ftl", data);
		return result;
	}
}
