 ...
 * 开发时间: 2012-8-15 <br>
 */
public class FFormProcessor extends FTemplateTagProcessor
{
	/*
	 * (non-Javadoc)
	...
	public String process() throws FException
	{
		...
		// 调用模板引擎
		String result = FEnvironment.get().getTemplateEngineWrapper().process(fcontext, "impl/FUI.Form-impl.ftl", data);
		return result;
	}
}
