...
import com.hundsun.jres.fui.tag.container.FButtonGroupProcessor;
 ...
 * 开发时间: 2012-8-15 <br>
 */
public class FButtonGroupTag extends FTagWithContent
{
	...
	public void setButtonAlign(String toolAlign)
	{
		this.buttonAlign = toolAlign;
	}
	...
	{
		return new FButtonGroupProcessor();
	}
