...
package com.hundsun.jres.fui.tag.bnt;
 ...
 * 开发时间: 2012-8-10 <br>
 */
public class FButtonProcessor extends FTemplateTagProcessor
{
	/*
	 * (non-Javadoc)
	...
	public String process() throws FException
	{
		...
		String result = FEnvironment.get().getTemplateEngineWrapper()
				.process(fcontext, "impl/FUI.Button-impl.ftl", data);
		return result;
	}
}
