...
import com.hundsun.jres.fui.tag.form.FTargetSelectProcessor;
 ...
 * 开发时间: 2012-8-21 <br>
 */
public class FTargetSelectTag extends FTagWithContent
{
	...
	{
		return new FTargetSelectProcessor();
	}
	...
	protected void doBeforeProcess()
	{
		...
		parameters.put("onTriggerClick", onTriggerClick);
