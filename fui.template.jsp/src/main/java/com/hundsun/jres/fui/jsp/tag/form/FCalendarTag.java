...
import com.hundsun.jres.fui.tag.form.FCalendarProcessor;
 ...
 * 开发时间: 2012-8-21 <br>
 */
public class FCalendarTag extends FTagWithContent
{
	...
	public void setShowOpts(String showOpts)
	{
	...
	protected void doBeforeProcess()
	{
		...
		parameters.put("showOpts", showOpts);
